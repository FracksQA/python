...
oldAdress = 'C:/Users/adminitsd/Desktop/teste/'  # pasta origem
newAdress = 'C:/Users/adminitsd/Desktop/Projetos_BigData/teste2/'  # pasta destino
...
while x < lista_len:
    ...
    shutil.copyfile(caminhoCompleto_old, caminhoCompleto_new)  # módulo 'shutil.move()' move os arquivos
